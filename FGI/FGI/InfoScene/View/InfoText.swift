...
enum InfoText: String {
    case title = "Что такое индекс страха и жадности?"
    case annotation1 = "\tУоррен Баффетт предупреждал: «Будьте осторожными, когда другие жадничают. Будьте жадными, когда другие осторожничают». Осталось понять настроение толпы. В этом помогает индекс страха и жадности — "
    case url = "Fear and Greed Index."
